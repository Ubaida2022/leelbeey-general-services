...
- Tailoring training for aspiring designers
- Textiles & fashion products (Ankara, Atamfa, lace, Abaya, veils, shoes, bags)
- Kitchen utensils
- Web development
- Graphic design

The website showcases all services and products using real business images, and provides direct WhatsApp integration for customer enquiries.
...
├── gallery.html        ← Gallery page (with filter + lightbox)
├── tailoring.html      ← Tailoring & Training page
├── contact.html        ← Contact page (with form)
│
├── css/
│   └── style.css       ← All styles (design system + page styles)
│
├── js/
│   └── script.js       ← Navigation, gallery, lightbox, form, animations
│
├── images/
│   ├── logo/           ← Business logo
│   │   └── logo.jpg
│   ├── kitchen/        ← Kitchen utensil images (kitchen-01.jpg ... kitchen-35.jpg)
│   ├── tailoring/      ← Tailoring/sewing images (tailoring-01.jpg ... tailoring-11.jpg)
│   └── textiles/       ← Textile/fashion images (textile-01.jpg ... textile-37.jpg)
│
└── README.md
```
...
| Tailoring | "…I would like to enquire about tailoring services." |
| Training | "…I would like to enquire about your tailoring training programme." |
| Textiles | "…I would like to enquire about your available textiles and fashion products." |
| Kitchen | "…I would like to enquire about your kitchen utensils." |
